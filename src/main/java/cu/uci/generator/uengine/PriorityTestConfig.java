...
public class PriorityTestConfig {
...
//    }
    ...
    public SimpleMessageListenerContainer responseListener()
        ...
        bean.setQueueNames("submit.queue.plow","submit.queue.phigh");
        
        bean.setAcknowledgeMode(AcknowledgeMode.MANUAL);
//        bean.setConcurrentConsumers(2);
        
        bean.setMessageListener(priorityTest);
